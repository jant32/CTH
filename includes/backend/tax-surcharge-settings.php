...
/**
 * Rendert die Admin-Seite für die Steuereinstellungen (Tax Surcharge Settings)
 */
function cth_render_tax_surcharge_settings_page() {

    // Prüfe, ob WooCommerce geladen ist – insbesondere die Klasse WC_Tax
    if ( ! class_exists( 'WC_Tax' ) ) {
        echo '<div class="error"><p>WooCommerce ist nicht geladen. Bitte aktivieren Sie WooCommerce und aktualisieren Sie diese Seite.</p></div>';
        return;
    }
...
<?php
// Am Ende der Datei ob_end_flush() aufrufen, um den Puffer freizugeben
ob_end_flush();